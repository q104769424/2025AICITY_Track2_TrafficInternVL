...
python generate_test_frames.py \
    ...
    --bdd-test-folder $test_root/SubTask1-Caption/WTS_DATASET_PUBLIC_TEST/external/BDD_PC_5K/bbox_global/test/public \
    --wts-test-folder $test_root/SubTask1-Caption/WTS_DATASET_PUBLIC_TEST/bbox_global/test/public \
