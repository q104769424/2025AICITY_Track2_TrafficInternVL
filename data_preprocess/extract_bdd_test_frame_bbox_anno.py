...
video_root_path = os.path.join(args.root, 'SubTask1-Caption/WTS_DATASET_PUBLIC_TEST/external/BDD_PC_5K/videos/test/public')
annotation_path = os.path.join(args.root, 'SubTask1-Caption/WTS_DATASET_PUBLIC_TEST/external/BDD_PC_5K/annotations/caption/test/public_challenge')
bbox_path = os.path.join(args.root, 'SubTask1-Caption/WTS_DATASET_PUBLIC_TEST_BBOX/external/BDD_PC_5K/annotations/bbox_annotated/test/public')
