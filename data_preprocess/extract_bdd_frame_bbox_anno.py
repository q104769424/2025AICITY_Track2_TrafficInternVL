...
video_root_path = os.path.join(args.root, 'BDD_PC_5k/videos', args.split)
annotation_path = os.path.join(args.root, 'BDD_PC_5k/annotations/caption', args.split)
bbox_path = os.path.join(args.root, 'BDD_PC_5k/annotations/bbox_annotated', args.split)
...
with open(os.path.join(args.save_folder, f'bdd_{args.split}_all_video_with_bbox_anno_first_frame.json'), 'w') as f:
