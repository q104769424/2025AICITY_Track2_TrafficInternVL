...
if __name__ == '__main__':
    ...
    wts_ann_path = os.path.join(args.test_root, 'SubTask1-Caption/WTS_DATASET_PUBLIC_TEST/annotations/caption/test/public_challenge')
    wts_bbox_path = os.path.join(args.test_root, 'SubTask1-Caption/WTS_DATASET_PUBLIC_TEST_BBOX/annotations/bbox_annotated/pedestrian/test/public')
    bdd_video_path = os.path.join(args.test_root, 'SubTask1-Caption/WTS_DATASET_PUBLIC_TEST/external/BDD_PC_5K/videos/test/public')
